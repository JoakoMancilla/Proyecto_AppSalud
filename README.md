...
Crear desde el **panel admin** los siguientes usuarios:
- Administrador
- Médico
- Enfermero
...
Al cargar las camas, se debe asignar manualmente el área o especialidad  
(UCI, Urgencias, UTI, Ginecología, etc.).
